...
import { likeAComment } from "../../services/comments/LikeAComment";
import { IoHeart } from "react-icons/io5";
import { unlikeAComment } from "../../services/comments/UnlikeAComment";
export default function ListComments({
    ...
    const handleLikeComment = (id) => {
        const LikeComment = async (id) => {
            const res = await likeAComment(id, userAuth?.meta?.token);
            console.log(res);
            if (res.is_liked) {
    ...
    const handleUnLikeComment = (id) => {
        const UnlikeComment = async (id) => {
            const res = await unlikeAComment(id, userAuth?.meta?.token);
            console.log(res);
            if (!res.is_liked) {
                setLikeCounts((prev) => prev - 1);
                    ...
                    <Stack>
                        ...
                        <Stack justifyContent={"center"} alignItems={"center"}>
                            {likeComment ? (
                                ...
                                >
                                    <HeartIcon color="rgba(22, 24, 35, 0.5)" />
                                </Typography>
                            )}
